...
STAR_BUG_FILTERS = {
    ...
    "F560W": _F(5.589, 0.207, 1.882, STAR_BUG_MIRI, NULL),
    "F770W": _F(7.528, 0.269, 2.445, STAR_BUG_MIRI, NULL),
    "F1000W": _F(9.883, 0.328, 2.982, STAR_BUG_MIRI, NULL),
    "F1130W": _F(11.298, 0.375, 3.409, STAR_BUG_MIRI, NULL),
    "F1280W": _F(12.712, 0.420, 3.818, STAR_BUG_MIRI, NULL),
    "F1500W": _F(14.932, 0.488, 4.436, STAR_BUG_MIRI, NULL),
    "F1800W": _F(17.875, 0.591, 5.373, STAR_BUG_MIRI, NULL),
    "F2100W": _F(20.563, 0.674, 6.127, STAR_BUG_MIRI, NULL),
    "F2550W": _F(25.147, 0.803, 7.300, STAR_BUG_MIRI, NULL),
}
